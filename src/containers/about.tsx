...
const AboutSection = () => {
  ...
  return (
    <section id='about' className='relative'>
      ...
      <SectionTitle title="about me " description='a quick introduction about me '
      className='items-start'
      />
      <p className='text-lg'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis dolores, aut alias adipisci esse illo ab. Eveniet labore recusandae est.
      </p>
